...
import { getCaloriesNormByFormula, formulas } from "../utils/caloriesNorm";
...
export default class CaloriesCounter {
    ...
    handleSubmit(evt) {
        ...
        const caloriesNormByDefault = this.getCaloriesNorm(formulas.default);
        const caloriesNormByHarrison = this.getCaloriesNorm(formulas.harrison);

        const caloriesByDefault = {
            norm: caloriesNormByDefault,
            minimal: this.getCaloriesMinimal(caloriesNormByDefault),
            maximal: this.getCaloriesMaximal(caloriesNormByDefault),
        };

        const caloriesByHarrison = {
            norm: caloriesNormByHarrison,
            minimal: this.getCaloriesMinimal(caloriesNormByHarrison),
            maximal: this.getCaloriesMaximal(caloriesNormByHarrison),
        };

        this.result.show(caloriesByDefault, caloriesByHarrison);
    }
    ...
    getCaloriesNorm(formula) {
        ...
        const caloriesNorm = getCaloriesNormByFormula(
            formula,
            weight,
            height,
            age,

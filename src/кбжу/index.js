<script type="text/javascript">
    ...
    if (caltype=='g') {document.getElementById("l1").innerHTML = "grams"};
    document.getElementById("l2").innerHTML="grams";
    document.getElementById("l3").innerHTML="grams";
    document.getElementById("l4").innerHTML="grams";
    ...
    if (caltype=='pounds') {fat1 = fneed * 0.0022} ;
    pro1 = pneed * 0.0022 ;
    car1 = crneed * 0.0022 ;
    alh1 = aneed * 0.0022 ;
    fat1=fat1.toFixed(3);
    ...
    if(!number.match(/^[0-9\.]+$/) && number !=""){number = number.substring(0, number.length - 1)};document.getElementById(id).value = number;
    }
    ...
    if (caltype=='g') {document.getElementById("rc").value = " " + cneed};
    document.getElementById("rf").value=" "+fneed;
    document.getElementById("rp").value=" "+pneed;
    document.getElementById("rh").value=" "+crneed;
    document.getElementById("ra").value=" "+aneed;
